...
public class LogUtil {
	...
	private final static Logger SUPPLIERLOG = LoggerFactory.getLogger("SUPPLIER_LOG");
	...
	public static void writeLog(String cont) {
		SUPPLIERLOG.info(INFO_LOG + cont);
	}
	...
	public static void writeErrorLog(String cont) {
		SUPPLIERLOG.error(ERROR_LOG + cont);
	}
	...
	public static void writeErrorLog(String cont, Throwable ex) {
		SUPPLIERLOG.error(ERROR_LOG + cont, ex);
	}
	...
	public static void debug(String cont) {
		if (SUPPLIERLOG.isDebugEnabled()) {
			SUPPLIERLOG.debug(DEBUG_LOG + cont);
		}
	}
}
