...
public class LogUtil {
	...
	private final static Logger TIMETASK = LoggerFactory.getLogger("TIMETASK_LOG");
	...
	public static void writeErrorLog(String cont, Throwable ex) {
		TIMETASK.error(ERROR_LOG + cont, ex);
	}
	...
	public static void debug(String cont) {
		if (TIMETASK.isDebugEnabled()) {
			TIMETASK.debug(DEBUG_LOG + cont);
		}
	}
}
